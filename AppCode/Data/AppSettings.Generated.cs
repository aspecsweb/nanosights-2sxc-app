...
namespace AppCode.Data
{
  ...
  /// Most properties have a simple access, such as `.ProjectKey`. <br/>
...
namespace AppCode.Data.AutoGenerated
{
  ...
  {
    /// <summary>
    /// ProjectKey as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("ProjectKey", scrubHtml: true) etc.
    /// </summary>
    public string ProjectKey => _item.String("ProjectKey", fallback: "");

    /// <summary>
    /// UserID as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("UserID", scrubHtml: true) etc.
    /// </summary>
    public string UserID => _item.String("UserID", fallback: "");
  }
}